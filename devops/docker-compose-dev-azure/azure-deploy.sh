...
resourcename="cardealershipdatabase"  # lower case, only
resourcegroup="cardealershipdatabase_rg"
...
# git clone https://github.com/apilogicserver/cardealershipdatabase.git
...
az group create --name cardealershipdatabase_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group cardealershipdatabase_rg --sku S1 --is-linux
az container create --resource-group cardealershipdatabase_rg --name cardealershipdatabase --image apilogicserver/cardealershipdatabase:latest --dns-name-label cardealershipdatabase --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//cardealershipdatabase.westus.azurecontainer.io:5656'
