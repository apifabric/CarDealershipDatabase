...
try:
    ...
    dealer1 = Dealer(name="City Auto", address="123 Main St.", contact_number="555-1234")
    dealer2 = Dealer(name="Town Motors", address="789 Elm St.", contact_number="555-6789")
    dealer3 = Dealer(name="Auto Plaza", address="456 Oak St.", contact_number="555-4567")
    dealer4 = Dealer(name="Village Cars", address="321 Pine St.", contact_number="555-9876")
    customer1 = Customer(name="John Doe", email="jdoe@example.com", phone="555-1212")
    customer2 = Customer(name="Jane Smith", email="jsmith@example.com", phone="555-3434")
    customer3 = Customer(name="Alice Brown", email="abrown@example.com", phone="555-5656")
    customer4 = Customer(name="Bob Green", email="bgreen@example.com", phone="555-7878")
    sale1 = Sale(car_id=1, customer_id=1, sale_date=date(2021, 6, 15), amount=25000)
    sale2 = Sale(car_id=2, customer_id=2, sale_date=date(2021, 7, 18), amount=22000)
    sale3 = Sale(car_id=3, customer_id=3, sale_date=date(2021, 8, 21), amount=35000)
    sale4 = Sale(car_id=4, customer_id=4, sale_date=date(2021, 9, 25), amount=20000)
